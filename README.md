...
- `node['chef_client']['systemd']['stderr']` - Controls where stdout of the executed process is connected. [systemd.exec man page](https://www.freedesktop.org/software/systemd/man/systemd.exec.html#StandardError=)
