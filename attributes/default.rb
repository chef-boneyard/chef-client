...
when 'openindiana', 'opensolaris', 'nexentacore', 'solaris2', 'omnios'
  ...
  default['chef_client']['bin_path'] = '/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin'
when 'smartos'
  default['chef_client']['init_style']  = 'smf'
  default['chef_client']['run_path']    = '/var/run/chef'
  default['chef_client']['cache_path']  = '/var/chef/cache'
  ...
  default['chef_client']['locale'] = 'en_US.UTF-8'
  default['chef_client']['bin_path'] = '/usr/local/sbin:/usr/local/bin:/opt/local/sbin:/opt/local/bin:/usr/sbin:/usr/bin:/sbin'
when 'windows'
